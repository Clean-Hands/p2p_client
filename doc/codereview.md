...
If you need to install cargo, run the curl command found [here](https://www.rust-lang.org/tools/install), or refer to the [development.md](https://github.com/rubenboero21/cs347/blob/main/doc/development.md) file.
