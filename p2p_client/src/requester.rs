...
/// if let Err(e) = add_peer(&alias, &peer_address) {
...
///
/// ```rust
/// let addr = String::from("10.123.456.789");
...
fn resolve_peer(peer: &String) -> Result<String, String> {
...
/// let file_path = String::from("~/Desktop");
